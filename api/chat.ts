...
const CALCULATORS: CalcEntry[] = [
  ...
  { name: 'Margin of Error Calculator', path: '/calculators/margin-of-error', category: 'Research Methodology', description: 'Calculate the margin of error for survey results given sample size, confidence level, and population proportion.', tags: ['margin of error', 'survey', 'precision', 'confidence interval', 'statistics'] },
  ...
  { name: 'Weighted Scoring Calculator', path: '/calculators/weighted-scoring', category: 'Research Methodology', description: 'Calculate weighted scores for criteria, options, or alternatives using customisable weights and scores.', tags: ['weighted average', 'multi-criteria', 'decision making', 'scoring', 'evaluation'] },
  ...
  { name: 'Z-Score Calculator', path: '/calculators/z-score', category: 'Statistics', description: 'Calculate z-scores to standardise values and determine how many standard deviations a data point is from the mean.', tags: ['z-score', 'standardization', 'normal distribution', 'outlier', 'statistics', 'standardise'] },
  ...
  { name: 'Risk Matrix Calculator', path: '/calculators/risk-matrix', category: 'Social Science & Decision Tools', description: 'Assess and prioritise project or research risks using a 5x5 likelihood-impact matrix.', tags: ['risk matrix', 'risk assessment', 'project management', 'likelihood', 'impact', 'decision making'] },
  ...
  { name: 'Quadratic Equation Calculator', path: '/calculators/quadratic-equation', category: 'Math Calculators', description: 'Solve ax squared + bx + c = 0 using the quadratic formula.', tags: ['quadratic', 'equation', 'roots', 'discriminant', 'math', 'school', 'student'] },
  ...
  { name: '2x2 Matrix Calculator', path: '/calculators/matrix-calculator', category: 'Math Calculators', description: 'Compute determinant, trace, inverse, and transpose of a 2x2 matrix.', tags: ['matrix', 'determinant', 'inverse', 'transpose', 'linear algebra', 'math'] },
  ...
  { name: 'Force Calculator', path: '/calculators/force-calculator', category: 'Physics Calculators', description: "Calculate force using Newton's second law (F = ma).", tags: ['force', 'mass', 'acceleration', 'Newton law', 'physics', 'school'] },
  ...
  { name: 'Kinetic Energy Calculator', path: '/calculators/kinetic-energy-calculator', category: 'Physics Calculators', description: 'Calculate kinetic energy from mass and velocity.', tags: ['kinetic energy', 'mass', 'velocity', 'joules', 'physics', 'school'] },
  ...
  { name: 'pH Calculator', path: '/calculators/ph-calculator', category: 'Chemistry Calculators', description: 'Calculate pH from hydrogen ion concentration.', tags: ['pH', 'hydrogen ion', 'acid', 'base', 'chemistry', 'lab', 'school'] },
  ...
  // Biology & Health
  { name: 'BMI Calculator', path: '/calculators/bmi-calculator', category: 'Biology & Health', description: 'Estimate body mass index from height and weight (BMI = kg / m squared).', tags: ['BMI', 'body mass index', 'weight', 'height', 'health', 'wellness', 'obesity', 'underweight'] },
  ...
  { name: 'Relative Risk Calculator', path: '/calculators/relative-risk', category: 'Biology & Health', description: 'Estimate relative risk and number needed to treat from a 2x2 contingency table.', tags: ['relative risk', 'epidemiology', 'NNT', 'odds ratio', 'public health', '2x2 table', 'RR'] },
  ...
  { name: 'AI Risk Assessment Calculator', path: '/calculators/ai-risk-assessment', category: 'Cybersecurity & AI Governance', description: 'Estimate AI system risk from data, transparency, oversight, bias, security, and operational impact.', tags: ['AI risk', 'AI assessment', 'governance', 'bias', 'security', 'AI oversight'] },
  ...
  { name: 'Password Entropy Calculator', path: '/calculators/password-entropy', category: 'Everyday Life', description: 'Estimate the information entropy of a password to assess its theoretical strength.', tags: ['password entropy', 'password bits', 'security', 'strength'] },
...
function getCalculatorKnowledgeBase(): string {
...
const SYSTEM_PROMPT = `You are Digi, a friendly virtual assistant from Digibly, supporting users of ResearchCalcHub. Help users find the right calculator or tool, understand formulas, interpret results, upload and analyse data, export reports, and navigate the platform confidently.

${getCalculatorKnowledgeBase()}
...
KEYWORD MAPPINGS — use these when user wording differs from calculator names:
...
- two coders / inter-rater / two raters / coder reliability → Cohen's Kappa (/calculators/cohens-kappa)
...
- interview data / thematic analysis / qualitative coding / open-ended → Qualitative Thematic Analysis Tool (/calculators/qualitative-thematic-analysis)
- upload CSV / upload Excel / import data / upload file → Data Upload Workspace (/data-upload)
- advanced statistics / statistical analysis / run stats → Stat Analyzer Pro (/stat-analyzer)
...
Do not replace a qualified statistician, supervisor, or professional consultant. Encourage users to verify important academic, medical, legal, financial, or professional results. Keep responses concise and practical.`;
